...
(1, 1, 'Aeriel', 'Sommerton', 'aeriel.sommerton@web.de', 1, 'Dance is my outlet for energy and creativity. I practice various styles and perform in competitions, always striving to learn new choreography.', 'mentor'),
(2, 2,  'Meaghan', 'Le Ball', 'meaghan.leball@hotmail.com', 2, 'Cooking and experimenting with new recipes is what I love most. I often host dinner parties for my friends to try out new dishes.', 'mentor'),
(3, 3, 'Ondrea', 'Kinsella', 'ondrea.kinsella@yahoo.co.in', 3, 'Video games are my favorite pastime. I enjoy strategy games that challenge my mind and continuously seek to improve my skills.', 'mentor'),
(4, 4, 'Kile', 'McPhelimey', 'kile.mcphelimey@libero.it', 4, 'Dance is my outlet for energy and creativity. I practice various styles and perform in competitions, always striving to learn new choreography.', 'mentor'),
(5, 5, 'Ash', 'Uff', 'ash.uff@hotmail.com', 5, 'Math challenges and numbers are where I find solace. Sudoku and puzzles occupy my free time, alongside participating in national math competitions.', 'mentor'),
(6, 6,  'Shelli', 'Milius', 'shelli.milius@neuf.fr', 6, 'I have a passion for mathematics and spend most of my time solving complex equations. Outside of academics, I enjoy playing chess and competing in local tournaments.', 'mentor'),
