...
-- abroadProgram Data
INSERT INTO abroadProgram (programID, programName, prgmDescription, locationID, programType, empID, prgmPhotoPath) VALUES
(1, 'Vienna', 'Experience innovation in Vienna with a focus on startups, venture capital, and entrepreneurship.', 1, 'Dialogue of Civilizations', 1, 'austria.png'),
...
(9, 'Rome', 'Witness the urban evolution of Rome and study urban planning, real estate, and architecture.', 9, 'Dialogue of Civilizations', 9, 'italy.png'),
(10, 'Amsterdam', 'Participate in our intensive studies program in Amsterdam, focusing on history, politics, and contemporary culture.', 10, 'Traditional Study Abroad', 10, 'netherlands.png'),
(11, 'Oslo', 'Analyze the economic landscape of Oslo while studying international economics and development.', 11, 'Traditional Study Abroad', 11, 'sweden.png'),
(12, 'Warsaw', 'Engage with the community development efforts in Warsaw while studying sociology and humanitarian action.', 12, 'Dialogue of Civilizations', 12, 'poland.png'),
(13, 'Lisbon', 'Experience the vibrant city life of Lisbon and study Portuguese language and culture through hands-on projects.', 13, 'NU.in', 13, 'portugal.png'),
(14, 'Madrid', 'Witness the urban evolution of Madrid and study urban planning, real estate, and architecture.', 14, 'Dialogue of Civilizations', 14, 'spain.png'),
(15, 'Stockholm', 'Immerse yourself in the healthcare system of Stockholm, with practical sessions in public health and medical ethics.', 15, 'Dialogue of Civilizations', 15, 'sweden.png'),
(16, 'Bern', 'Participate in wildlife conservation efforts in Bern, focusing on ecosystem management and biology studies.', 16, 'Traditional Study Abroad', 16, 'switzerland.png'),
(17, 'London', 'Experience innovation in London with a focus on startups, venture capital, and entrepreneurship.', 17, 'Traditional Study Abroad', 17, 'uk.png'),
(18, 'Barcelona', 'Discover the ancient history of Barcelona while participating in archaeological digs and classical studies.', 18, 'NU.in', 18, 'spain.png'),
(19, 'Munich', 'Dive into the history and business environment of Munich with a focus on international finance and management practices.', 19, 'NU.in', 19, 'germany.png'),
(20, 'Stuttgart', 'Engage with the community development efforts in Stuttgart while studying sociology and humanitarian action.', 20, 'Dialogue of Civilizations', 20, 'germany.png'),
(21, 'Frankfurt', 'Participate in a comprehensive language and culture program in Frankfurt, offering insights into Vietnam''s rapid growth.', 21, 'Traditional Study Abroad', 21, 'germany.png'),
(22, 'Hamburg', 'Experience Hamburg through the lens of political science and economics, understanding the European context.', 22, 'Semester.in', 22, 'germany.png'),
(23, 'Cologne', 'Participate in wildlife conservation efforts in Cologne, focusing on ecosystem management and biology studies.', 23, 'Dialogue of Civilizations', 23, 'germany.png'),
(24, 'Düsseldorf', 'Experience innovation in Düsseldorf with a focus on startups, venture capital, and entrepreneurship.', 24, 'Dialogue of Civilizations', 24, 'germany.png'),
(25, 'Leipzig', 'Study fashion and culture in the bustling city of Leipzig, a global hub for design and creativity.', 25, 'Traditional Study Abroad', 25, 'germany.png'),
(26, 'Bordeaux', 'Participate in Bordeaux''s economic growth story with a focus on entrepreneurship and international business.', 26, 'Semester.in', 26, 'france.png'),
(27, 'Nice', 'Explore Nice''s approach to sustainability with courses in renewable energy and environmental management.', 27, 'Traditional Study Abroad', 27, 'france.png'),
(28, 'Lyon', 'Dive into the rich cultural scene of Lyon with courses in music, history, and the arts.', 28, 'NU.in', 28, 'france.png'),
(29, 'Marseille', 'Study fashion and culture in the bustling city of Marseille, a global hub for design and creativity.', 29, 'Dialogue of Civilizations', 29, 'france.png'),
(30, 'Naples', 'Experience the unique blend of tradition and modernity in Naples with courses in history, culture, and politics.', 30, 'Traditional Study Abroad', 30, 'italy.png'),
...
(4, 'Kile', 'McPhelimey', 'kile.mcphelimey@libero.it',  'Dance is my outlet for energy and creativity. I practice various styles and perform in competitions, always striving to learn new choreography.', 'mentor', 'generic_pfp.png'),
(5, 'Ash', 'Uff', 'ash.uff@hotmail.com',  'Math challenges and numbers are where I find solace. Sudoku and puzzles occupy my free time, alongside participating in national math competitions.', 'mentor', 'generic_pfp.png'),
(6, 'Shelli', 'Milius', 'shelli.milius@neuf.fr',  'I have a passion for mathematics and spend most of my time solving complex equations. Outside of academics, I enjoy playing chess and competing in local tournaments.', 'mentor', 'generic_pfp.png'),
(7, 'Fayth', 'Sodor', 'fayth.sodor@gmx.de',  'Dance is my outlet for energy and creativity. I practice various styles and perform in competitions, always striving to learn new choreography.', 'mentor', 'generic_pfp.png'),
(8, 'Nahum', 'Seeler', 'nahum.seeler@wanadoo.fr',  'Video games are my favorite pastime. I enjoy strategy games that challenge my mind and continuously seek to improve my skills.', 'mentor', 'generic_pfp.png'),
(9, 'Scotti', 'Rivallant', 'scotti.rivallant@gmail.com',  'I enjoy writing and have a blog where I share book reviews and personal thoughts. Connecting with readers from around the world is enriching.', 'mentor','generic_pfp.png'),
(10, 'Cosme', 'Elliot', 'cosme.elliot@yahoo.com',  'Science is my favorite subject, especially biology. Exploring the natural world and understanding how things work piques my interest like nothing else!', 'mentor','generic_pfp.png'),
(11, 'Goldy', 'Evesque', 'goldy.evesque@gmail.com',  'I am an avid reader and love diving into fantasy novels. When I am not studying, you can find me writing short stories or exploring new coffee shops around town.', 'mentor','generic_pfp.png'),
(12, 'Court', 'Gildroy', 'court.gildroy@gmail.com', 'Music runs in my family, and I play the guitar in a band with my friends. On weekends, we perform at local gigs, bringing energy to the stage.', 'mentor','generic_pfp.png'),
(13, 'Mahala', 'Boerderman', 'mahala.boerderman@gmail.com',  'Technology and coding are my main interests. I spend weekends participating in hackathons and building apps to solve everyday problems.', 'mentor', 'generic_pfp.png'),
(14, 'Avrom', 'Nilges', 'avrom.nilges@gmail.com',  'Social justice is close to my heart, and I volunteer at a local community center. Advocating for change and helping others drives me.', 'mentor', 'generic_pfp.png'),
(15, 'Charin', 'Boggish', 'charin.boggish@yahoo.co.id',  'Video games are my favorite pastime. I enjoy strategy games that challenge my mind and continuously seek to improve my skills.', 'mentor', 'generic_pfp.png'),
(16, 'Wallie', 'Sandon', 'wallie.sandon@yahoo.com',  'Outdoor adventures are what I live for. Whether it is hiking, camping, or rock climbing, being in nature gives me peace and brings out the best in me.', 'mentee', 'generic_pfp.png'),
(17, 'Ryun', 'Athy', 'ryun.athy@hotmail.com',  'Technology and coding are my main interests. I spend weekends participating in hackathons and building apps to solve everyday problems.', 'mentee', 'generic_pfp.png'),
(18, 'Gates', 'Ledeker', 'gates.ledeker@gmail.com',  'Acting is my passion, and I participate in school plays and local theater productions. I thrive on stage and love bringing characters to life.', 'mentee', 'generic_pfp.png'),
(19, 'Bliss', 'Conibear', 'bliss.conibear@freenet.de',   'Social justice is close to my heart, and I volunteer at a local community center. Advocating for change and helping others drives me.', 'mentee', 'generic_pfp.png'),
(20, 'Carny', 'Huniwall', 'carny.huniwall@gmail.com',  'Cooking and experimenting with new recipes is what I love most. I often host dinner parties for my friends to try out new dishes.', 'mentee', 'generic_pfp.png'),
(21, 'Vyky', 'Worsnip', 'vyky.worsnip@hotmail.com',  'I have a passion for mathematics and spend most of my time solving complex equations. Outside of academics, I enjoy playing chess and competing in local tournaments.', 'mentee', 'generic_pfp.png'),
(22, 'Trenna', 'Gerbel', 'trenna.gerbel@hotmail.com',  'I am an avid reader and love diving into fantasy novels. When I am not studying, you can find me writing short stories or exploring new coffee shops around town.', 'mentee', 'generic_pfp.png'),
(23, 'Ebonee', 'Halkyard', 'ebonee.halkyard@yahoo.com.br',  'Photography helps me capture the world from different perspectives. Whether it is landscagit pes or portraits, I love finding beauty in everyday life.', 'mentee', 'generic_pfp.png'),
(24, 'Keenan', 'Mowson', 'keenan.mowson@yahoo.com',  'I enjoy writing and have a blog where I share book reviews and personal thoughts. Connecting with readers from around the world is enriching.', 'mentee', 'generic_pfp.png'),
(25, 'Yorke', 'Bensusan', 'yorke.bensusan@sbcglobal.net',  'Sports are my life! I am the captain of the soccer team and love spending my afternoons practicing or watching matches with friends.', 'mentee', 'generic_pfp.png'),
(26, 'Wilton', 'Worsell', 'wilton.worsell@yahoo.fr',  'Math challenges and numbers are where I find solace. Sudoku and puzzles occupy my free time, alongside participating in national math competitions.', 'mentee', 'generic_pfp.png'),
(27, 'Alayne', 'Whitnell', 'alayne.whitnell@yahoo.com',  'Math challenges and numbers are where I find solace. Sudoku and puzzles occupy my free time, alongside participating in national math competitions.', 'mentee', 'generic_pfp.png'),
(28, 'Fanchon', 'Quarry', 'fanchon.quarry@hotmail.com',  'Video games are my favorite pastime. I enjoy strategy games that challenge my mind and continuously seek to improve my skills.', 'mentee', 'generic_pfp.png'),
(29, 'Cahra', 'Wooster', 'cahra.wooster@wanadoo.fr',   'Acting is my passion, and I participate in school plays and local theater productions. I thrive on stage and love bringing characters to life.', 'mentee', 'generic_pfp.png'),
(30, 'Amy', 'McAviy', 'amy.mcaviy@msn.com', 'Outdoor adventures are what I live for. Whether it is hiking, camping, or rock climbing, being in nature gives me peace and brings out the best in me.', 'mentee', 'generic_pfp.png'),
(31, 'Tim', 'Waltz', 't.waltz@northeastern.edu', 'I am a second-year Northeastern student studying Business who recently returned from my transformative Dialogue of Civilizations in Marseille, France. When I am not mentoring, I enjoy tennis, Stardew Valley, and chocolate chip cookies.  I look forward to connecting with you, feel free to reach out to me at w.tim@northeastern.edu!', 'mentor', 'Tim_Waltz_headshot.png'),
(32, 'Tom', 'Holland', 't.holland@northeastern.edu', 'I am a Northeastern Business student looking to go on a Dialogue of Civilations for business! Looking for mentors!', 'mentee', 'Tom_Holland_headshot.png');
